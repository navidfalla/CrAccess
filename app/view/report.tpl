...
<form id="report-form" action="<?= BASE_URL ?>/report/process" method = "POST">
  ...
  <tr><td>Description:</td><td> <textarea name="description" id="description" rows="8" cols="103" placeholder="Write a description of the issue in detail"></textarea></td></tr>
	<tr><td>Summary:</td><td> <textarea name="summary" id="summary" rows="4" cols="103" placeholder="Write a summary less than 20 words"></textarea></td></tr>
